...
def flatten_LPF(df, N, scale, mednmom,currun, cmap, dirpath, rundirpath):
	...
	#X and Z switched
        ...
        if i == 0:               #Parameterized Correctly, Check done
            ...
            #face0 = [xs, ys, [binsy,binsx],[minfacex,maxfacex],[minfacey,maxfacey]) ##################
            ...
            ax.add_patch(patch0)
            #Plots Color
            face0 = [xedges,yedges,Hist,norm,my_cmap, patch0]###########################
        ...
        ##this side is transformed like 5
            ...
            #face1 = [xs, ys, [binsy,binsx],[minfacex,maxfacex],[minfacey,maxfacey]) ##################
            ...
            face1 = [x+xplace,y+yplace,Hist,norm,my_cmap, patch1]###########################
        ...
        ### Y is actually Z
            ...
            #face2 = [xs, ys, [binsy,binsx],[minfacex,maxfacex],[minfacey,maxfacey]) ##################
            ...
            #Plots the hist
            face2 = [xedges,yedges,Hist,norm,my_cmap, patch2]#######################
            ax.pcolormesh(xedges,yedges,Hist, norm = norm, cmap = my_cmap, #interpolation='nearest', origin='lower',
        ...
        #This side is rotated 
            ...
            #face3 = [xs, ys, [binsy,binsx],[minfacex,maxfacex],[minfacey,maxfacey]) ##################
            ...
            x,y = DoRotation(xedges,yedges,(-theta))
            face3 = [x+xplace,y+yplace,Hist,norm,my_cmap, patch3]#######################
        ...
        ### X is actually Z
            ...
            face4 = [xedges,yedges,Hist,norm,my_cmap, patch4]#######################
        ...
        #This side is transformed like 1
            ...
            np.asarray(ys) 
            #create hist and edges from transformed data
            #face5 = [xs, ys, [binsy,binsx],[minfacex,maxfacex],[minfacey,maxfacey]) ##################
            ...
            #rotate hist
            x,y = DoRotation(-xedges,-yedges,(theta))
            face5 = [x+xplace,y+yplace,Hist,norm,my_cmap, patch5]#######################
        ...
        ### Y is actually Z
            ...
            #face6 = [xs, ys, [binsy,binsx],[minfacex,maxfacex],[minfacey,maxfacey]) ##################
            ...
            #Plots the hist
            face6 = [xedges,yedges,Hist,norm,my_cmap, patch6]#######################
        ...
        #this side is transformed, like 3
            ...
            #Creates Histogram in Easy (X,Z) reference frame
            #face7 = [xs, ys, [binsy,binsx],[minfacex,maxfacex],[minfacey,maxfacey]) ##################
            ...
            #Rotates Matrix by theta radians
            x,y = DoRotation(xedges,-yedges,(-theta))
            face7 = [x+xplace,y+yplace,Hist,norm,my_cmap, patch7]#######################
        ...
        #This is the bottom, flip initial conditions, x = x, y = -y, z = z 
            ...
            ys = np.asarray(ys) 
            #Create Histogram
            #face8 = [xs, ys, [binsy,binsx],[minfacex,maxfacex],[minfacey,maxfacey]) ##################
            ...
            #face8 = [xedges,yedges,Hist,norm,my_cmap, patchbot1]#######################
            ax.pcolormesh(xedges,yedges,Hist, norm = norm, cmap = my_cmap, #interpolation='nearest', origin='lower',
        ...
        # This is the top, keep initial conditions, x = x, y = y ... 
            ...
            xs = np.asarray(xs)
            ys = np.asarray(ys)
            #face9 = [xs, ys, [binsy,binsx],[minfacex,maxfacex],[minfacey,maxfacey]) ##################
            ...
            #Plots the hist, and gets cropped by the octogon
            face9 = [xedges,yedges,Hist,norm,my_cmap, patchtop]#######################
    ...
    return face0,face1,face2,face3,face4,face5,face6,face7,face8,face9 ###########################
...
def ploterror(mednmom,currun, dirpath, rundirpath, homedir, where_run):    
    freqs   = []
